        ...
        <div className="contenedor-chats-page">
            <div className="left-column-chats">
                <div className="searchChatCommunity flex gap-1">
                    ...
                    <div className={`icon-text-group hover:opacity-50 cursor-pointer ${selectedType === 'group' ? 'icon-selected' : ''}`} onClick={() => handleTypeChange('group')}>
                    ...
                    <div className={`icon-text-group hover:opacity-50 cursor-pointer ${selectedType === 'private' ? 'icon-selected' : ''}`} onClick={() => handleTypeChange('private')}>
