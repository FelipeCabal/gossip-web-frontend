...
const Comunidades = () => {
    ...
    return (
        <div className="rounded-lg w-auto">
            ...
            <div className=" mt-1 w-auto -mr-14">
                {comunidades.map((comunidad) => (
                    <div key={comunidad.id} className="flex items-center border-b-2 justify-around  border-b-[#918ef4] w-full -ml-10">
                        <img src={icono} alt="Icono de búho" className="w-32 " />
